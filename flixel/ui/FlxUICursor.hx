...
import flixel.input.FlxBaseMultiInput;
import flixel.input.keyboard.FlxMultiKey;
import flixel.input.gamepad.FlxGamepad;
import flixel.input.gamepad.FlxGamepadInputID;
import flixel.input.gamepad.FlxMultiGamepad;
import flixel.input.gamepad.FlxMultiGamepadAnalogStick;
